      ...
      <Box w={'100%'} overflow="hidden">
        <Stack px={5} mb={1}>
          <HStack justifyContent="space-between">
            ...
            <TouchableOpacity
              onPress={() => {
                navigation.navigate('Order_Unpaid_Detail', {
        ...
        <Stack px={5} my={2}>
          <HStack justifyContent="space-between">
            ...
            <Text bold>
              Rp.{' '}
              {isDetail(order) !== ''
                ? currencyFormat(order.orderDetails[0].PRODUCTTOTAL)
                : '0.00'}
            </Text>
          </HStack>
        </Stack>
        <Stack px={5} mb={5}>
          <HStack justifyContent="flex-end" alignItems="center" space={2}>
            ...
            <Text color="gray.400">10:34:09</Text>
            <TouchableOpacity
              onPress={() => {
...
export default function UnpaidPage({navigation}) {
